...
function Component() {
  ...
  return (
    ...
    <div class="flex flex-col items-center mt-6 -mx-2">
        ...
        <p class="mx-2 mt-1 text-sm font-medium text-gray-600 dark:text-gray-400">example.com</p>
    </div>
    ...
    <div className="flex flex-col flex-wrap w-full md:pl-20 md:w-9/12  h-auto">
    {data.map(item => (
