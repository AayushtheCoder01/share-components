...
export default function FormCard({handleSubmit, setCode, setComponent, setDescription}) {
  ...
  return (
    ...
    <div className="flex items-center justify-center w-16 bg-yellow-500">
    ...
    <div className="px-4 py-1 -mx-3">
        <div className="mx-3">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-200">Please remove all the variable and loops from the component! Upload only raw jsx.</p>
        </div>
    </div>
</div>
      </div>
