  ...
  return (
    ...
    <header className="flex px-5 items-center h-16 bg-gray-100 px-4 w-full shrink-0">
      ...
      <div className="flex items-center space-x-4 ml-auto px-4">
        {userData.name? <div className="text-lg hidden md:block font-semibold text-gray-500 border border-green-300 bg-green-100 p-1 px-3 rounded-3xl">{userData.name}</div> : ""}
